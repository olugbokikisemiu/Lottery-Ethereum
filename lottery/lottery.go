...
const LotteryABI = "[{\"inputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"constant\":true,\"inputs\":[],\"name\":\"allPlayer\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"playerAddress\",\"type\":\"address\"}],\"name\":\"enter\",\"outputs\":[],\"payable\":true,\"stateMutability\":\"payable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"manager\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"players\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"selectWinner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"

// LotteryBin is the compiled bytecode used for deploying new contracts.
var LotteryBin = ""
...
//
// Solidity: function enter(address playerAddress) returns()
func (_Lottery *LotteryTransactor) Enter(opts *bind.TransactOpts, playerAddress common.Address) (*types.Transaction, error) {
	return _Lottery.contract.Transact(opts, "enter", playerAddress)
}

// Enter is a paid mutator transaction binding the contract method 0xd014c01f.
//
// Solidity: function enter(address playerAddress) returns()
func (_Lottery *LotterySession) Enter(playerAddress common.Address) (*types.Transaction, error) {
	return _Lottery.Contract.Enter(&_Lottery.TransactOpts, playerAddress)
}

// Enter is a paid mutator transaction binding the contract method 0xd014c01f.
//
// Solidity: function enter(address playerAddress) returns()
func (_Lottery *LotteryTransactorSession) Enter(playerAddress common.Address) (*types.Transaction, error) {
	return _Lottery.Contract.Enter(&_Lottery.TransactOpts, playerAddress)
}
